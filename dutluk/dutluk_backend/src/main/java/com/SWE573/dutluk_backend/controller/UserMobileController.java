...
public class UserMobileController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getUserByIdMobile(@PathVariable Long id, HttpServletRequest request) throws AccountNotFoundException {
    ...
    @GetMapping("/logout")
    public ResponseEntity<?> logoutMobile(HttpServletResponse response) {
    ...
    public ResponseEntity<?> registerUserMobile(@RequestBody RegisterRequest registerRequest) {
