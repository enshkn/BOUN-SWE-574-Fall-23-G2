...
abstract class $CommentModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? text, User? user, List<int>? likes});
...
class _$_CommentModel extends _CommentModel {
  const _$_CommentModel({this.id, this.text, this.user, final List<int>? likes})
      : _likes = likes,
        super._();
  ...
  @override
  String toString() {
    return 'CommentModel(id: $id, text: $text, user: $user, likes: $likes)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, text, user, const DeepCollectionEquality().hash(_likes));
...
abstract class _CommentModel extends CommentModel {
  const factory _CommentModel(
      ...
      final String? text,
      final User? user,
      final List<int>? likes}) = _$_CommentModel;
