...
class TextStyles extends TextStyle {
  const TextStyles.hugeTitle()
      : super(fontSize: 26, fontWeight: FontWeight.w700);
  const TextStyles.bigTitle()
      : super(fontSize: 20, fontWeight: FontWeight.w700);
  const TextStyles.title() : super(fontSize: 16, fontWeight: FontWeight.w700);
  const TextStyles.subtitle()
      : super(fontSize: 14, fontWeight: FontWeight.w400);
  ...
  const TextStyles.listTitle()
      : super(fontSize: 16, fontWeight: FontWeight.w400);
}
