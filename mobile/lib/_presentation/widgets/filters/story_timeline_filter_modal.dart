...
class StoryTimelineFilterModal extends StatefulWidget {
  ...
  State<StoryTimelineFilterModal> createState() =>
      _StoryTimelineFilterModalState();
}

class _StoryTimelineFilterModalState extends State<StoryTimelineFilterModal> {
  ...
  void setFilter(StoryFilter? filter) {
    ...
    label = widget.currentFilter!.label;
    title = widget.currentFilter!.title;
    ...
    titleController.text = widget.currentFilter!.title ?? '';
    labelController.text = widget.currentFilter!.label ?? '';
    this.filter = filter;
  }
...
/*   Future<void> getCurrentLocation() async {
  ...
  Future<void> onPressSubmit() async {
    final filter = StoryFilter(
      ...
      label: labelController.text != '' ? labelController.text : null,
    );
